...
\\\\
Na końcu rankingu zwróconego przez \texttt{importance} znalazły się atrybuty:
\\\\
...
dPoniżej przedstawiono wyniki uzyskane przez dostrojony k-NN, naiwny klasyfikator Bayesa oraz SVM. 
